 ...
 *
 * Purpose: To calculate the great circle distance
 *          and initial bearing  as per assignment 7 SER423 2018 Spring B
 *
...
public class CalculationsActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spn_place1 = (Spinner)findViewById(R.id.spn_place1);
        spn_place2 = (Spinner)findViewById(R.id.spn_place2);
        btn_calc = (Button)findViewById(R.id.btn_doCalc);
        tv_greatCircle = (TextView)findViewById(R.id.result_GreatCircle);
        tv_initialHeading = (TextView)findViewById(R.id.result_initBearing);
    ...
    private void loadSpinners() {
        try {
            ...
            locs = (String[]) al.toArray(new String[al.size()]);
